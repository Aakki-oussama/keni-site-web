    ...
    <button
      ...
      className={`py-0.5 border-b transition-colors duration-300 ${
        isLight
          ...
          : "border-gray-900 text-gray-900 hover:border-brand"
      }`}
      aria-label={
        isAr ? "Changer la langue en Français" : "تغيير اللغة إلى العربية"
      }
    >
      <span
        className={`text-[13px] font-medium leading-none ${isAr ? "font-sans" : "font-arabic"}`}
      >
